          ...
          >
            {profile.photoUrl ? (
              <div className="relative mx-auto flex w-full max-w-sm items-center justify-center">
                ...
                <div
                  aria-hidden="true"
                  className="pointer-events-none absolute right-4 top-1/2 h-52 w-52 -translate-y-1/2 rounded-full bg-violet-500/25 blur-[70px]"
                />
                <div
                  aria-hidden="true"
                  className="pointer-events-none absolute bottom-8 left-4 h-52 w-52 rounded-full bg-electric-500/20 blur-[70px]"
                />
                ...
                {/* A gentle float animation and drop-shadow give the cutout its "3D" lift —
                    ...
                    transparent-background PNG (see the note in profile.js). Capped at
                    26rem tall so it stays in proportion to the heading beside it rather
                    than towering over the whole hero. */}
                <motion.img
